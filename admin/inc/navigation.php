...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-light-green navbar-light elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link bg-green text-sm">
